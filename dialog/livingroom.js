...
let ellie2b = [
    "[ ELLIE MACLEAN, a front crawler on WBHS VARSITY WOMEN'S SWIM. ]",
    "CHOICE_ggTALK TO ELLIE^0_ssHAVE YOU SEEN SUZY?^7_yyASK TO SIGN YEARBOOK^8_DO NOTHING^11",
    "nice to see you one last time. where are you going in the fall again?",
    "CHOICE_georgia tech.^0_out of state.^1_you first.^2",
    "sweet. good luck out there, man.^9",
    "i mean, obviously. who'd want to stay in this dump?^8",
    "oberlin.",
    "to be honest... i'm kind of excited for college.",
    "gonna miss the shit out of ANGIE, though.^5",
    "no, sorry...^4",
    "...",
    "[ ELLIE signs your YEARBOOK. ]",
    "SIGN"
...
let angela2b = [
    "[ ANGELA YAO, a backstroker for WBHS VARSITY WOMEN'S SWIM. ]",
    "CHOICE_ggTALK TO ANGELA^0_ssHAVE YOU SEEN SUZY?^9_yyASK TO SIGN YEARBOOK^11_DO NOTHING^14",
    ...
    "BRAD, though... i don't think he knows that's not your name...^9",
    ...
    "i'm just gonna miss ELLIE...^6",
    "ahh, no, i'm sorry DREW... :(",
    "she's a smart kid, though! i'm sure she's not getting into trouble.^4",
    "omg of course i'll sign your yearbook!!!",
    "[ ANGELA signs your YEARBOOK. ]",
    "SIGN"
]
...
let brad2b = [
    "[ BRAD SZYMANSKI, a breaststroker for WBHS VARSITY MEN'S SWIM. ]",
    "CHOICE_ggTALK TO BRAD^0_ssHAVE YOU SEEN SUZY?^11_yyASK TO SIGN YEARBOOK^13_DO NOTHING^16",
    ...
    "at least six shots of flameball.^9",
    "a whole blunt. all by myself.",
    "are you proud of me?^7",
    "[ BRAD takes you up on that FIST BUMP, grinning wide. ]^6",
    "sorry, dude, i haven't seen her.",
    "someone definitely has, though! just keep asking around.^4",
    "hell yeah, dude! i'll sign your yearbook.",
    "[ BRAD signs your YEARBOOK. ]",
    "SIGN"
]
...
let jake2b = [
    "[ JAKE GIORDANO, a fellow butterflyer and the captain of WBHS MEN'S VARSITY SWIM. ]",
    "CHOICE_ggTALK TO JAKE^0_ssHAVE YOU SEEN SUZY?^12_yyASK TO SIGN YEARBOOK^13_DO NOTHING^17",
    ...
    "though i'll always wish your fly time wasn't better than mine. god damn.^11",
    ...
    "if you want to be the best flyer in georgia, you gotta get those arms UP!^7",
    "[ JAKE just laughs. ]^6",
    "nope. you've got this, though.^5",
    "awwww, ANDY, you're adorable.",
    "sure, why not? i'll sign it.",
    "[ JAKE signs your YEARBOOK. ]",
    "SIGN"
